...
/**
 * 통합 테스트 베이스 — 실제 MySQL 컨테이너 1개를 <b>싱글톤</b>으로 공유.
 *
 ...
 *
 * <p>{@code @ServiceConnection}이 이 컨테이너에 맞춰 datasource를 자동 구성한다. JSON 컬럼·임베디드·UNIQUE 제약 등 MySQL 전용
 * 동작을 진짜로 검증(mock·H2로는 불가).
 */
@SpringBootTest
